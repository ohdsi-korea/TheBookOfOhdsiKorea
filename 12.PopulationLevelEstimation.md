...
<div class="figure" style="text-align: center">
<img src="images/PopulationLevelEstimation/covsToExclude.png" alt="배제할 concept을 정의하는 concept set" width="100%" />
...
\BeginKnitrBlock{rmdimportant}<div class="rmdimportant">만약 어떤 변수가 매우 예측적 'highly predictive' 이라면, 두 가지 결론을 내릴 수 있다. 하나는 변수가 노출과 매우 밀접한 관계가 있기 때문에 모델 적합 전에 제외해야 한다든가, 또는 표적군과 대조군이 실제로 비교가 불가능하기 때문에 분석을 멈추어야 한다는 것이다.</div>\EndKnitrBlock{rmdimportant}
...
<div class="figure" style="text-align: center">
<img src="images/PopulationLevelEstimation/attrition.png" alt="Attrition diagram. 맨 위에 표시된 개수는 우리의 목표와 대조군 코호트 정의를 충족하는 개수이다. 하단의 개수는 결과 모델에 입력되는 개수로서, 이 경우는 콕스 회귀 분석이다." width="70%" />
<p class="caption">(\#fig:attrition)Attrition diagram. 맨 위에 표시된 개수는 우리의 목표와 대조군 코호트 정의를 충족하는 개수이다. 하단의 개수는 결과 모델에 입력되는 개수로서, 이 경우는 콕스 회귀 분석이다.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/PopulationLevelEstimation/followUp.png" alt="표적 및 대조군 코호트의 추적 시간 분포." width="80%" />
<p class="caption">(\#fig:followUp)표적 및 대조군 코호트의 추적 시간 분포.</p>
</div>
