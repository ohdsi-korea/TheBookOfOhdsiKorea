...
![(\#fig:implementations)CDM의 데이터에 대한 분석을 구현하는 다양한 방법](images/OhdsiAnalyticsTools/implementations.png)
...
![(\#fig:strategies)(임상적) 질문에 대한 근거를 생성하기 위한 전략](images/OhdsiAnalyticsTools/strategies.png)
...
![(\#fig:atlas)ATLAS 사용자 인터페이스](images/OhdsiAnalyticsTools/atlas.png)
...
![(\#fig:methodsLibrary)The OHDSI Methods Library의 패키지](images/OhdsiAnalyticsTools/methodsLibrary.png)
...
![(\#fig:downloadR)CRAN으로부터 R 다운로드](images/OhdsiAnalyticsTools/downloadR.png)
...
![(\#fig:rDestination)R의 대상 폴더 설정하기.](images/OhdsiAnalyticsTools/rDestination.png)

![(\#fig:no32Bits)32-bit 버전의 R을 사용하지 않도록 설정하기.](images/OhdsiAnalyticsTools/no32Bits.png)
...
![(\#fig:downloadRStudio)RStudio 다운로드](images/OhdsiAnalyticsTools/downloadRStudio.png)
...
![(\#fig:downloadJava)Java 다운로드](images/OhdsiAnalyticsTools/downloadJava.png)
...
![(\#fig:ohdsiinaboxDiagram)OHDSI-in-a-Box용 Amazon Web Services 아키텍처](images/OhdsiAnalyticsTools/OHDSI-in-a-BoxDiagram.png)
...
![(\#fig:ohdsionawsDiagram)OHDSIonAWS를 위한 Amazon Web Services 아카이브](images/OhdsiAnalyticsTools/OHDSIonAWSDiagram.png)
