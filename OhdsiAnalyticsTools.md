...
\BeginKnitrBlock{rmdimportant}<div class="rmdimportant">윈도우즈에서 R과 Java는 32-bit 및 64-bit 아키텍처를 모두 제공한다. 두 아키텍처에 R을 설치하는 경우, **반드시** 두 아키텍처에 모두 Java를 설치해야 한다. R은 64-bit 버전만 설치하는 것을 추천한다.</div>\EndKnitrBlock{rmdimportant}
