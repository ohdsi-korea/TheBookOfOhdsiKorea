...
<img src="images/ExtractTransformLoad/WhiteRabbitLocation.png" alt="&quot;Pick Folder&quot; 버튼은 White Rabbit 애플리케이션의 작업 폴더 사양을 허용한다." width="100%" />
<p class="caption">(\#fig:WhiteRabbitLocation)"Pick Folder" 버튼은 White Rabbit 애플리케이션의 작업 폴더 사양을 허용한다.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ExtractTransformLoad/usagiImport.png" alt="Usagi 원천 코드 입력화면." width="100%" />
<p class="caption">(\#fig:usagiImport)Usagi 원천 코드 입력화면.</p>
</div>
