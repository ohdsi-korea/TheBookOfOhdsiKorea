...
```{r missingMapping, fig.cap='orphan 소스코드 예시. ',echo=FALSE, out.width='70%', fig.align='center'}
...
```{r sourceCodesAngioedema, fig.cap='Angioedema 코호트 정의에서 사용된 소스코드.',echo=FALSE, out.width='100%', fig.align='center'}
