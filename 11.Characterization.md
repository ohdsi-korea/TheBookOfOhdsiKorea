...
<div class="figure" style="text-align: center">
<img src="images/Characterization/atlasDataSourcesConditionFiltered.png" alt="Atlas 데이터 소스: 개념명에서 &quot;고혈압 hypertension&quot;이라는 단어를 이용해 걸러낸 결과" width="100%" />
<p class="caption">(\#fig:atlasDataSourcesConditionFiltered)Atlas 데이터 소스: 개념명에서 "고혈압 hypertension"이라는 단어를 이용해 걸러낸 결과</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/Characterization/atlasCharacterizationResultsExplore.png" alt="특성 분석 결과 - 하나의 개념에 대하여 자세한 내용이 들어 있는 새로운 창." width="100%" />
<p class="caption">(\#fig:atlasCharacterizationResultsExplore)특성 분석 결과 - 하나의 개념에 대하여 자세한 내용이 들어 있는 새로운 창.</p>
</div>
